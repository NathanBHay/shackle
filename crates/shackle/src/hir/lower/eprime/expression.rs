use crate::{
	...
	hir::{source::Origin, lower::minizinc::TypeInstIdentifiers},
	syntax::{ast::{AstNode, Children}, eprime},
	Error,
};
...
impl ExpressionCollector<'_> {
	...
	pub fn collect_domain(&mut self, t: eprime::Domain, var_type: VarType) -> ArenaIndex<Type> { // Possibly add var_type: VarType 
